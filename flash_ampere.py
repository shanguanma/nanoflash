# copy and modified from https://github.com/Dao-AILab/flash-attention/blob/main/flash_attn/cute/interface.py
...
from flash_fwd_ampere import FlashAttentionForwardSm80


from flash_bwd_ampere import FlashAttentionBackwardPreprocess
from flash_bwd_ampere import FlashAttentionBackwardSm80
from flash_bwd_ampere import FlashAttentionBackwardPostprocess
...
def _flash_attn_bwd(
    ...
    lse_tensor = convert_from_dlpack(lse.detach(), leading_dim=2, alignment=4)
    dq_accum_tensor, dpsum_tensor, lse_log2_tensor = [
        convert_from_dlpack(t.detach(), leading_dim=2, divisibility=128 // cutlass.Float32.width)
